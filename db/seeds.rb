...
kakuzi = Stock.create(:name => 'Kakuzi Limited', :stock_symbol => 'KAZU', :stock_exchange_id => nse.id, :category_id => 1)
rvipingo = Stock.create(:name => 'Rea Vipingo Plantations Limited', :stock_symbol => 'REA', :stock_exchange_id => nse.id, :category_id => 1)
kakuzi = Stock.create(:name => 'Kakuzi Limited', :stock_symbol => 'KAZU', :stock_exchange_id => nse.id, :category_id => 1)
kakuzi = Stock.create(:name => 'Kakuzi Limited', :stock_symbol => 'KAZU', :stock_exchange_id => nse.id, :category_id => 1)
kakuzi = Stock.create(:name => 'Kakuzi Limited', :stock_symbol => 'KAZU', :stock_exchange_id => nse.id, :category_id => 1)
kakuzi = Stock.create(:name => 'Kakuzi Limited', :stock_symbol => 'KAZU', :stock_exchange_id => nse.id, :category_id => 1)
